...
export default function ContactDetail() {
  ...
  <div className="flex items-center mb-6">
    <a href="dashboard.html" className="text-blue-400 hover:text-blue-300 mr-4 flex items-center transition-colors duration-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="bg-gray-700 bg-opacity-50 p-5 rounded-lg shadow-md border border-gray-600 card-hover">
            ...
            <div className="flex justify-end space-x-3">
              <Link to="/dashboard/addresses/edit" className="px-4 py-2 bg-gradient text-white rounded-lg hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-all duration-200 font-medium shadow-md flex items-center">
